...
public class TempleScraper extends AbstractScraper {

    private final static Logger logger = LoggerFactory.getLogger(TempleScraper.class);

    public TempleScraper(Integer year) {
        super(year);
    }

    public College getCollege() {
        return College.TEMPLE;
    }
    ...
    Athlete parseAthleteRow(Element tableRowElement) {
        ...
        if (this.year <= 2022 && this.year > 2016) {
            eventIndex = 2;
            hometownIndex = 4;
            clubIndex = 6;
