...
public class SoutheastMissouriScraper extends AbstractScraper {

    public final static Logger logger = LoggerFactory.getLogger(SoutheastMissouriScraper.class);

    public SoutheastMissouriScraper(Integer year) {
        super(year);
    }

    public College getCollege() {
        return College.SOUTHEASTMISSOURI;
    }

    String buildRosterUrl() {
        return this.year > 2012 ?
                String.format("%s/%d?view=2",
                        "https://semoredhawks.com/sports/womens-gymnastics/roster",
                        this.year) :
