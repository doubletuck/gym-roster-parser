...
public class RosterController {
    ...
    private List<Athlete> scrapeAthleteRosterFromWebsite(Integer year, College college) {
        ...
        switch (college) {
            ...
            case BRIDGEPORT -> athletes = new BridgeportScraper(year).parseAthletes();
            ...
            case FISK -> athletes = new FiskScraper(year).parseAthletes();
            ...
            case TEXASWOMANS -> athletes = new TexasWomansScraper(year).parseAthletes();
